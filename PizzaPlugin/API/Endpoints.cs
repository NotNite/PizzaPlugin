...
public class Endpoints {
    public static Dictionary<string, string> UnitedStates =>
        new() {
            ...
            { "price_url", "https://order.dominos.com/power/price-order" }, {
                "track_by_order",
                "https://trkweb.dominos.com/orderstorage/GetTrackerData?StoreID={store_id}&OrderKey={order_key}"
            },
    ...
    public static Dictionary<string, string> Canada =>
        new() {
            ...
            { "price_url", "https://order.dominos.ca/power/price-order" }, {
                "track_by_order",
                "https://trkweb.dominos.ca/orderstorage/GetTrackerData?StoreID={store_id}&OrderKey={order_key}"
            },
